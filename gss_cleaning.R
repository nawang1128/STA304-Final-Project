...
raw_data <- read_csv("/Users/Nancy/Desktop/GSS 2017/AA6tbHjo.csv")
dict <- read_lines("/Users/Nancy/Desktop/GSS 2017/gss_dict.txt", skip = 18) # skip is because of preamble content
# Now we need the labels because these are the actual responses that we need
labels_raw <- read_file("/Users/Nancy/Desktop/GSS 2017/gss_labels.txt")
